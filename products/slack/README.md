...
4. If using a manifest, paste the contents of `slack-app-manifest.yml`
5. Name: "Fortress Token Optimizer"
...
export FORTRESS_URL="https://api.fortress-optimizer.com"
...
docker run -e SLACK_BOT_TOKEN="xoxb-..." \
           ...
           -e FORTRESS_URL="https://api.fortress-optimizer.com" \
           fortress-slack-bot
```
...
1. Complete app metadata (name, description, icons).
2. Provide privacy policy and support URL.
3. Verify scopes and events match functionality.
4. Submit for review at https://api.slack.com/apps

Checklist:
- Privacy Policy URL: https://fortress-optimizer.com/legal/privacy
- Terms of Service URL: https://fortress-optimizer.com/legal/terms
- Support URL: https://fortress-optimizer.com/support
