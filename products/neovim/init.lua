...
function M.show_usage_window(usage)
  ...
  local lines = {
    ...
    "=====================",
    "",
    string.format("Used: %d / %d tokens", usage.tokens_used_this_month, usage.tokens_limit),
    string.format("Remaining: %d tokens", usage.tokens_remaining),
    string.format("Progress: %.1f%%", usage.percentage_used),
    string.format("Reset: %s", usage.reset_date),
  }
