...
const botResponses: { [key: string]: string } = {
  ...
  save: 'Our customers see an average of 25% token reduction, with some seeing up to 40% depending on their use case. Check your dashboard for personalized metrics.',
