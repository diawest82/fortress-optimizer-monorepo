  ...
  const installGuides = [
    {
      ...
      icon: '📦',
      docsUrl: 'https://docs.fortress-optimizer.com/docs/installation/npm',
      steps: [
    ...
    },
    {
      ...
      icon: '🤖',
      docsUrl: 'https://docs.fortress-optimizer.com/docs/installation/copilot',
      steps: [
    ...
    },
    {
      ...
      icon: '💬',
      docsUrl: 'https://docs.fortress-optimizer.com/docs/installation/slack',
      steps: [
    ...
    },
    {
      ...
      icon: '⚙️',
      docsUrl: 'https://docs.fortress-optimizer.com/docs/installation/vscode',
      steps: [
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          ...
          <div className="card-dark p-6 text-center">
            ...
            <a href="https://docs.fortress-optimizer.com/docs/api-reference" className="text-blue-400 hover:text-blue-300 text-sm">
              View API Docs →
            </a>
          </div>
        </div>
